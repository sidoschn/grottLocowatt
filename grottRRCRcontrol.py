    ...
    def interpretGPIOstates(self):
        ...
        match self.currentGPIOstates:
            ...
            case _:
                ...
                print("Safety power down, conflicting info")
                newExportLimit = self.safetyPowerDownPercent
        ...
        if not (newExportLimit == self.currentExportLimit):
            ...
            if not hasattr(self.currentProxy, "loggerId"):
                ...
                command = self.currentProxy.compileCommand(self.currentConfig ,"ExportPower", newExportLimit) 
                print(command)
                
                #self.currentProxy.injectCommand(self.currentConfig, command) #disabled for testing
        else:
